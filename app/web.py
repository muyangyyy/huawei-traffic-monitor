    ...
    def do_GET(self) -> None:
        ...
        try:
            if parsed.path == "/":
                ...
                self.send_json(read_config_json(self.server.data_dir))
                ...
                self.send_json({"events": self.server.db.recent_events()})
            else:
  ...
  <section class="device">
    ...
    <div class="body">
      <div class="grid">
        ...
        <div class="field"><label>团体字</label><input data-field="community" placeholder="public"></div>
...
function deviceDefaults(){return{id:"",name:"",host:"",snmp_version:"2c",community:"public",port:161,oid_profile:"if_mib_64",custom_oid:"",custom_direction:"in",custom_in_oid:"",custom_out_oid:"",monitor_interfaces:[],enabled:true,mock:false}}
...
<main class="app">
  ...
  <section class="layout">
    ...
    <aside class="side-panel"><h3>最近采集事件</h3><ul class="events" id="events"></ul></aside>
  </section>
</main>
<script>
